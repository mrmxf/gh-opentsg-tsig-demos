...
func (c Cube) generate(wObj, wTsig io.Writer) error {
	...
	tsig := TSIG{Tilelayout: tiles, Dimensions: Dimensions{Flat: XY2D{X0: 0, X1: int(pixelWidth), Y0: 0, Y1: int(pixelHeight)}}}
...
func (s Sphere) generate(wObj, wTsig io.Writer) error {
	...
	tsig := TSIG{Tilelayout: tiles, Dimensions: Dimensions{Flat: XY2D{X0: 0, X1: int(maxX), Y0: 0, Y1: int(maxY)}}}
